...
export const DINOS: Dino[] = [
  ...
  },
  {
    ...
    name: 'Espinosaurio',
    emoji: '🐊',
    tagline: 'El carnívoro pescador más grande',
    era: 'Cretácico',
    livedMya: 99,
    diet: 'carnívoro',
    color: '#3f6a8a',
    ...
    heightM: 5,
    lengthM: 15,
    scene: { scale: 0.5, path: { radius: 8.5, speed: 0.42, phase: 2.0 } },
    facts: [
      { icon: '📏', label: 'Tamaño', value: '¡Más largo que el T-Rex!' },
      { icon: '🐟', label: 'Comida', value: 'Peces gigantes: era medio acuático' },
      { icon: '⛵', label: 'Su vela', value: 'Una gran vela de piel en la espalda' },
      { icon: '🐊', label: 'Morro', value: 'Alargado, como el de un cocodrilo' },
    ],
    story: [
      { emoji: '🐊', title: '¡Soy Espinosaurio!', text: 'Fui el dinosaurio carnívoro más largo de todos, ¡aún más que el T-Rex! Y me encantaba el agua.' },
      { emoji: '🐟', title: 'Pescador', text: 'Con mi morro largo de cocodrilo pescaba peces enormes en los ríos. ¡Era casi como un cocodrilo gigante!' },
      { emoji: '⛵', title: 'Mi vela', text: 'En la espalda llevaba una gran vela de piel sujeta por espinas. Quizá me servía para presumir o para regular mi calor.' },
    ],
  },
  {
    id: 'compsognathus',
    name: 'Compsognathus',
    emoji: '🐔',
    tagline: 'Uno de los dinosaurios más pequeños',
    era: 'Jurásico',
    livedMya: 150,
    diet: 'carnívoro',
    color: '#8a9a5a',
    ...
    heightM: 0.4,
    lengthM: 1,
    scene: { scale: 0.28, path: { radius: 5.5, speed: 0.85, phase: 1.5 } },
    facts: [
      { icon: '🐔', label: 'Tamaño', value: 'Como una gallina' },
      { icon: '🏃', label: 'Veloz', value: 'Corría muy rápido con sus patas finas' },
      { icon: '🦗', label: 'Comida', value: 'Insectos y lagartijas' },
      { icon: '👀', label: 'Curiosidad', value: 'Se han hallado fósiles con su última comida dentro' },
    ],
    story: [
      { emoji: '🐔', title: '¡Soy Compsognathus!', text: 'Soy de los dinosaurios más pequeños que se conocen: ¡del tamaño de una gallina o un pavo!' },
      { emoji: '🏃', title: 'Rapidísimo', text: 'Con mis patas largas y finas corría muy rápido para cazar insectos y lagartijas.' },
      { emoji: '👀', title: 'Pequeño pero fiero', text: 'Aunque era chiquitín, era un cazador ágil y listo. ¡El tamaño no lo es todo!' },
    ],
  },
  {
    id: 'anquilosaurio',
    name: 'Anquilosaurio',
    emoji: '🛡️',
    tagline: 'El tanque acorazado con maza en la cola',
    era: 'Cretácico',
    livedMya: 68,
    diet: 'herbívoro',
    color: '#6b7a52',
    ...
    heightM: 1.7,
    lengthM: 8,
    scene: { scale: 0.5, path: { radius: 12.5, speed: -0.24, phase: 3.3 } },
    facts: [
      { icon: '🛡️', label: 'Armadura', value: 'La espalda cubierta de placas óseas' },
      { icon: '🏏', label: 'Cola', value: '¡Una maza de hueso para golpear!' },
      { icon: '🌿', label: 'Comida', value: 'Plantas bajas' },
      { icon: '🦕', label: 'Como un tanque', value: 'Bajo y anchote, difícil de voltear' },
    ],
    story: [
      { emoji: '🛡️', title: '¡Soy Anquilosaurio!', text: 'Voy cubierto de placas y pinchos óseos, como un caballero con armadura. ¡Casi nada podía morderme!' },
      { emoji: '🏏', title: 'Mi maza', text: 'Al final de mi cola tenía una bola de hueso enorme. De un mazazo podía romperle la pata a un T-Rex.' },
      { emoji: '🌿', title: 'Comeplantas tranquilo', text: 'Andaba despacio, cerca del suelo, comiendo plantas bajas sin preocuparme de nadie.' },
    ],
  },
];
