...
export const PLANETS: Body[] = [
  {
    ...
    scene: { size: 0.5, distance: 9, orbitSpeed: 0.5, rotationSpeed: 0.1, phase: 0.5, eccentricity: 0.34, periapsis: 0.5, inclination: 0.12 },
    facts: [
  ...
  },
  {
    ...
    scene: {
      ...
      rotationSpeed: -0.02,
      phase: 2.1,
      atmosphere: { color: '#f3d9a0', intensity: 1.1 },
    },
    facts: [
  ...
  },
  {
    ...
    scene: {
      ...
      tilt: 0.41,
      phase: 4.2,
      atmosphere: { color: '#7fb3ff', intensity: 1.2 },
    },
    facts: [
  ...
  },
  {
    ...
    scene: { size: 0.7, distance: 21.5, orbitSpeed: 0.2, rotationSpeed: 0.28, tilt: 0.44, phase: 1.3, eccentricity: 0.18, periapsis: 4.0, inclination: 0.03 },
    facts: [
  ...
  },
  {
    ...
    scene: {
      ...
      rotationSpeed: 0.5,
      phase: 5.1,
      atmosphere: { color: '#e8c89a', intensity: 0.8 },
    },
    facts: [
  ...
  },
  {
    ...
    scene: {
      ...
      atmosphere: { color: '#f0e2c0', intensity: 0.7 },
    },
    facts: [
  ...
  },
  {
    ...
    scene: {
      ...
      tilt: 1.71,
      phase: 0.9,
      rings: { inner: 1.8, outer: 2.4, color: '#a8d8d8', opacity: 0.3 },
      atmosphere: { color: '#9fe0e0', intensity: 1 },
    },
    facts: [
  ...
  },
  {
    ...
    scene: {
      ...
      rotationSpeed: 0.32,
      phase: 3.7,
      atmosphere: { color: '#5a7de0', intensity: 1.2 },
    },
    facts: [
...
export const DWARF_PLANETS: Body[] = [
  {
    ...
    scene: { size: 0.28, distance: 26.5, orbitSpeed: 0.15, rotationSpeed: 0.2, phase: 5.8, eccentricity: 0.2, periapsis: 1.0, inclination: 0.18 },
    facts: [
  ...
  },
  {
    ...
    scene: { size: 0.32, distance: 60, orbitSpeed: 0.04, rotationSpeed: 0.1, phase: 1.8, eccentricity: 0.3, periapsis: 2.2, inclination: 0.3 },
    facts: [
